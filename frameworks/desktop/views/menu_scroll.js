...
/** @scope SC.MenuScrollView.prototype */{
  ...
  */
  ...
  scrollTo: function (x, y) {
    ...
    var topThickness = this.getPath('verticalScrollerView.scrollerThickness'),
    ...
    if (!SC.none(y)) {
      ...
      } else if (vOffset > 0 && y - topThickness <= 0) {
        y = 0;
      }
  ...
  */
  tile: function () {
    ...
    if (vScrollerIsVisible) {
      ...
      layout.top = (vOffset === 0) ? 0 :
        scrollerThickness; // Scrolled; show the scrollbar.
